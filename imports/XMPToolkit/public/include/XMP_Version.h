...
///
/// This header defines a static version number for the XMP Toolkit, which describes the version of
...
#define XMPSCRIPT_API_VERSION_MAJOR  5
#define XMPSCRIPT_API_VERSION_MINOR  2

#define XMPCOMPAREANDMERGE_API_VERSION_MAJOR	1
#define XMPCOMPAREANDMERGE_API_VERSION_MINOR	0

#define XMPASSETMANAGEMENT_API_VERSION_MAJOR	1
#define XMPASSETMANAGEMENT_API_VERSION_MINOR	0
...
#define XMPASSETMANAGEMENT_API_VERSION MACRO_PASTE(XMPASSETMANAGEMENT_API_VERSION_MAJOR, ., XMPASSETMANAGEMENT_API_VERSION_MINOR)
...
#define XMPASSETMANAGEMENT_API_VERSION_STRING MAKESTR(XMPASSETMANAGEMENT_API_VERSION)
