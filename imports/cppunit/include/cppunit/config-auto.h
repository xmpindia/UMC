...
/* This file had (as it says) been generated by a configure script.
     Manually added to project. Not need by win build, only by mac btw
    (see respective #ifdef's in portability.h for instance)
*/
