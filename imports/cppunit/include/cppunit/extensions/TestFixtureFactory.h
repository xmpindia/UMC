...
/*! \brief Abstract TestFixture factory (Implementation).___macAA
 *
...
public:
  ...
  //Franks fix for xcode to avoid missing virtual-constructor warnings
  //(this line is the whole fix. Nothing in any other place.)
