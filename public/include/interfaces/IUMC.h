...
namespace UMC {
	...
	//!
	//! \brief This interface is used for getting, adding and removing various sources and outputs from UMC  
	//! \details Provides all the functions to get and set various properties nodes.
	//!
	class IUMC
		: public IUMCNode
	{
	public:
		...
		//!
		//! \brief Adds a new video source to UMC
		...
		//!
		//! \brief Adds a new audio source to UMC
		...
		//!
		//! \brief Creates a new video frame source using an existing video source and adds the newly created video frame source to UMC
		//! \param[in] videoSource A shared pointer to non const IVideoSource object representing the video source from which video frame source is to be created.
		//! \return a shared pointer to non const IVideoFrameSource object representing the newly added video frame source.
        //! \note std::logic_error exception is thrown in case buffer is empty
		//!
		virtual spIVideoFrameSource AddVideoFrameSource( const spIVideoSource & videoSource ) = 0;

		//!
		//! \brief Adds a new image source to UMC
		...
		//!
		//! \brief Creates a new source from a buffer
		//! \param[in] buffer A value of type std::string indicating the buffer from which the source object is to be created
		...
		//!
		//! \brief Creates a new video source from a buffer
		//! \param[in] buffer A value of type std::string indicating the buffer from which the video source object is to be created
		...
		//!
		//! \brief Creates a new audio source from a buffer
		//! \param[in] buffer A value of type std::string indicating the buffer from which the source object is to be created
		...
		//!
		//! \brief Adds a new output to UMC
		//! \return a shared pointer to non const IOutput object representing the newly added output.
		//!
		virtual spIOutput AddOutput() = 0;

		//!
		//! \brief Creates a new output from a buffer
		//! \param[in] buffer A value of type std::string indicating the buffer from which the output object is to be created
		...
		//!
		//! \brief Gets the count of audio sources present in the UMC
		...
		//!
		//! \brief Gets the count of video frame sources present in the UMC
		...
		//!
		//! \brief Gets the count of image sources present in the UMC
		...
		//!
		//! \brief Gets the list of all the sources present in the UMC
		...
		//!
		//! \brief Gets the list of all the video sources present in the UMC
		...
		//!
		//! \brief Gets the list of all the audio sources present in the UMC
		...
		//!
		//! \brief Gets the list of all the video frame sources present in the UMC
		...
		//!
		//! \brief Gets the list of all the image sources present in the UMC
		...
		//!
		//! \brief Gets the source from the UMC with a particular unique id
		//! param[in] uniqueID A value of type std::string indicating the unique id of the source
		...
		//!
		//! \brief Gets the video source from the UMC with a particular unique id
		//! param[in] uniqueID A value of type std::string indicating the unique id of the video source
		...
		//!
		//! \brief Gets the audio source from the UMC with a particular unique id
		//! \param[in] uniqueID A value of type std::string indicating the unique id of the audio source
		...
		//!
		//! \brief Gets the video frame source from the UMC with a particular unique id
		//! \param[in] uniqueID A value of type std::string indicating the unique id of the video frame source
		...
		//!
		//! \brief Gets the image source from the UMC with a particular unique id
		//! param[in] uniqueID A value of type std::string indicating the unique id of the image source
		...
		//!
		//! \brief Removes all the sources present in the UMC
		//! \return a value of type size_t indicating the count of sources present in the UMC
		//!
		virtual size_t RemoveAllSources() = 0;

		//!
		//! \brief Removes all the video sources present in the UMC
		//! \return a value of type size_t indicating the count of video sources present in the UMC
		//!
		virtual size_t RemoveAllVideoSources() = 0;

		//!
		//! \brief Removes all the audio sources present in the UMC
		//! \return a value of type size_t indicating the count of audio sources present in the UMC
		//!
		virtual size_t RemoveAllAudioSources() = 0;

		//!
		//! \brief Removes all the video frame sources present in the UMC
		//! \return a value of type size_t indicating the count of video frame sources present in the UMC
		//!
		virtual size_t RemoveAllVideoFramesSources() = 0;

		//!
		//! \brief Removes all the image sources present in the UMC
		//! \return a value of type size_t indicating the count of image sources present in the UMC
		//!
		virtual size_t RemoveAllImageSources() = 0;

		//!
		//! \brief Removes the source from the UMC with a particular unique id
		//! \param[in] uniqueID A value of type std::string indicating the unique id of the source
		...
		//!
		//! \brief Removes the video source from the UMC with a particular unique id
		//! \param[in] uniqueID A value of type std::string indicating the unique id of the video source
		...
		//!
		//! \brief Removes the audio source from the UMC with a particular unique id
		//! \param[in] uniqueID a value of type std::string indicating the unique id of the audio source
		...
		//!
		//! \brief Removes the video frame source from the UMC with a particular unique id
		//! \param[in] uniqueID A value of type std::string indicating the unique id of the video frame source
		...
		//!
		//! \brief Removes the image source from the UMC with a particular unique id
		//! param[in] uniqueID a value of type std::string indicating the unique id of the image source
		...
		//!
		//! \brief Gets the count of outputs present in the UMC
		//! \return a value of type size_t indicating the outputs present in the UMC
		//!
		virtual size_t OutputCount() const = 0;

		//!
		//! \brief Gets the list of all the outputs present in the UMC
		...
		//!
		//! \brief Gets the output from the UMC with a particular unique id
		//! \param[in] uniqueID A value of type std::string indicating the unique id of the output
		...
		//!
		//! \brief Removes all the outputs present in the UMC
		//! \return a value of type size_t indicating the count of outputs present in the UMC
		//!
		virtual size_t RemoveAllOutputs() = 0;

		//!
		//! \brief Removes the output from the UMC with a particular unique id
		//! \param[in] uniqueID A value of type std::string indicating the unique id of the output
		...
		//!
		//! \brief Creates an empty UMC object from a buffer
		//! \param[in] buffer a value of type std::string indicating the buffer from which UMC object is to be created
		...
		//!
		//! \brief Registers a new custom node handler or de-registers an existing custom data handler
		//! param[in] customDataNameSpace A value of type std::string indicating the namespace of the custom data for which the custom handler is to be registered
		//! param[in] customDataName A value of type std::string indicating the name of the custom data for which the custom handler is to be registered
		//! param[in] customDataHandler A shared pointer to a non-const object of type ICustomDataHandler representing the custom data handler to be created. If an empty shared pointer is provided, then the existing custom data handler is de-registerd. 
