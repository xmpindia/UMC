#ifndef DoViAvailableDisplaysHandler_h__
#define DoViAvailableDisplaysHandler_h__ 1
...
namespace NS_DisplayExtension {
	...
	public:
        ...
        const AvailableDisplays & getAvailableDisplays();
	protected:

		shared_ptr< AvailableDisplays > _availableDisplays;
        shared_ptr< Display> _currentDisplay;
	};
}

#endif  // DoViAvailableDisplaysHandler_h__
